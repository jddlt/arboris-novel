...
**每章字数大概在 3500～4500 字之间。** 这是一个参考范围，帮助你把握节奏和篇幅。
...
**记住：好文章的长度是故事本身决定的，不是字数要求决定的。当你真正投入到角色的世界里时，篇幅会自然而然地丰满起来。**
...
upcoming_chapters (后续章节预览)

作用: 这部分展示了接下来几章的标题和摘要，帮助你控制当前章节的节奏和边界。

**极其重要的创作纪律**:
- 后续章节的内容**绝对不能**在本章中提前写出
- 如果下一章的摘要提到某个事件，本章最多只能做铺垫，不能直接展开
- 本章的结尾应该为下一章创造一个自然的"钩子"或过渡点
- 严格遵守剧情边界：每章有自己的职责，不要越界

例如：如果下一章摘要是"主角发现了隐藏的秘密"，那么本章可以让主角注意到一些蛛丝马迹、产生怀疑，但**不能**让主角真正发现那个秘密。
...
"title":"string",
"summary":"string",
"full_content":"string",(3500～4500字)
}
